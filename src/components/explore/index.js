...
import { fetchPublishedTrips, fetchTrendingTrips, fetchPopularTrips, fetchPublishDateTrips, fetchRecentlyViewedTrips, resetTripId, viewTrip } from '../../actions/index.js';
import './index.scss'
...
class Explore extends Component {
  ...
  componentDidMount() {
      ...
      if (cookie.load('auth')) { this.props.fetchRecentlyViewedTrips(cookie.load('auth')) }
  }
  ...
  render() {
      ...
      if (hasPublishedTrips) {
          ...
          <div>
              ...
              <div>
                  {this.renderTripList(this.props.publishedViewedTrips, 20, 'Recently Viewed By You')}
...
const mapStateToProps = (state) => {
  return {
    ...
    publishedViewedTrips: state.trips.publishedViewedTrips
  };
};

export default withRouter(connect(mapStateToProps, { fetchPublishedTrips, fetchRecentlyViewedTrips, fetchTrendingTrips, fetchPopularTrips, fetchPublishDateTrips, resetTripId, viewTrip })(Explore));
